...
public class
    ...
    private void
        ...
        if (object instanceof String || object instanceof Float) {
            ...
            ByteBuffer bb = Constant.DEFAULT_CHARSET.encode(tempString);

            write(baos,
                  Constant.DEFAULT_CHARSET.encode(String.valueOf(bb.limit())));
                    ...
                    if (o_key instanceof byte[]) {
                        ...
                        if (byte_keys) {
                            ...
                            try {
                                ...
                                encode(baos, Constant.BYTE_CHARSET.encode(key));
            ...
            //write out the l
            baos.write('i');
            write(baos, Constant.DEFAULT_CHARSET.encode(tempLong.toString()));
            baos.write('e');
            ...
            //write out the l
            baos.write('i');
            write(baos, Constant.DEFAULT_CHARSET.encode(tempInteger.toString()));
            baos.write('e');
            ...
            write(baos,
                  Constant.DEFAULT_CHARSET.encode(String.valueOf(tempByteArray.
                    length)));
            baos.write(':');
