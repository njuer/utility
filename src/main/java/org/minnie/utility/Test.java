...
//		}
		...
		// + "\\resource\\cmd\\MysqlStart.bat";
		// System.out.println(path);
		//
		// Runtime rt = Runtime.getRuntime();
		// Process ps = null;
		// try {
		// ps = rt.exec("cmd.exe /C start " + path);
		// ps.waitFor();
		...
		// String leagueLogoLink =
		// "http://pimg1.126.net/caipiao_info/images/league/70/645.png?201410230305";
		...
		//
		// String res = hs.getResponseBodyByGet("trend.sohu.lecai.com",
		// "/dlt/redBaseTrend.action", nvps);
