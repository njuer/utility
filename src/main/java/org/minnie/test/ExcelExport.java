...
public class ExcelExport {
	...
	public static void excelExport() {
		...
		String[] colNames = { "", "Page View (PV)\r\n 浏览量",
				...
				"1st Top Seller\r\n 最佳销量", "Unit Price 单价", "Qty Sold 销量",
				"2nd Top Seller\r\n 第二销量", "Unit Price 单价", "Qty Sold 销量",
				...
				for (int c = 0; c < colNum; c++) {
					...
					if (r > 8) {
						...
						if (c == 0) {
							...
							cell.setCellValue((r % 3) == 0 ? today
									: (r % 3 == 1 ? "PV 浏览量" : "Total Sales 总额"));
							...
							if (r % 3 == 0) {
								if ((c & 1) == 1) {
									...
									anchor = new HSSFClientAnchor(10, 2, 0, 0,
											(short) c, r, (short) (c + 2),
											r + 1);
